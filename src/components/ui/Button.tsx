...
export function buttonClasses(variant: Variant = "primary", className?: string) {
  const base =
    "focus-ring gold-shine inline-flex min-h-11 items-center justify-center gap-2 rounded-md px-5 py-3 text-sm font-bold transition duration-200 hover:-translate-y-0.5 active:translate-y-0";
  const variants: Record<Variant, string> = {
    primary: "bg-primary text-white shadow-lg shadow-primary/15 hover:bg-secondary hover:shadow-xl",
    secondary: "bg-primary text-white shadow-lg shadow-black/15 hover:bg-secondary hover:shadow-xl",
    outline: "border border-slate-300 bg-white text-primary hover:border-accent hover:text-primary hover:shadow-md",
