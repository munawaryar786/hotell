    ...
    <header className="sticky top-0 z-50">
      ...
      <motion.div style={{ backgroundColor: bg }} className="border-b border-slate-200/90 backdrop-blur">
        <Container className="flex h-20 items-center justify-between gap-4">
          <Link href="/" className="focus-ring flex items-center gap-3 rounded-md" aria-label="Hotel Ambassador Lahore home">
            <span className="relative h-12 w-12 overflow-hidden rounded-full border border-slate-200 bg-white p-1 shadow-soft">
              <Image src={site.logo} alt="Hotel Ambassador Lahore logo" fill sizes="48px" className="object-contain" priority />
            </span>
            <span>
          ...
          <div className="hidden items-center gap-3 lg:flex">
            <ButtonLink href={whatsappUrl("Hello Hotel Ambassador Lahore, I want to inquire about room availability.")} variant="outline">
