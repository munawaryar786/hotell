    ...
    <Container>
      ...
      <LuxuryCarousel>
        {dining.map((item, index) => (
          <article key={item.title} className="group flex h-full flex-col overflow-hidden rounded-lg bg-black text-white shadow-soft transition hover:-translate-y-1 hover:shadow-lift">
